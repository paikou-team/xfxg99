...
<body style="overflow: hidden;">
    <div id="stockBillDiv">
        ...
        <p style="margin-top: -1px; margin-bottom: 0px">
        	<a id="btnAddGoods" href="javascript:void(0);" class="easyui-linkbutton" iconcls="icon-add" plain="true" onclick="onAddGoods()">添加</a>
        	<a id="btnDelGoods" href="javascript:void(0);" class="easyui-linkbutton" iconcls="icon-cancel" plain="true" onclick="onDelGoods()">删除</a>
            ...
            <a id="btnCheckBill" href="javascript:void(0);" class="easyui-linkbutton" iconcls="icon-ok" plain="true" onclick="onConfirmStockBill()">确认</a>
