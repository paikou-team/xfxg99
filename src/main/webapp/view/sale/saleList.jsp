...
<body  >
	<div > 
		<p style="float: left; width:100%; height:10px">
			...
			<a id="btnConfirmSaleBill"  href="javascript:void(0);" class="easyui-linkbutton" iconcls="icon-ok" plain="true" onclick="onSaleConfirm()">确认</a> 
			<a id="btnDelSaleBill"  href="javascript:void(0);" class="easyui-linkbutton" iconcls="icon-cancel" plain="true" onclick="onSaleDel()">删除</a>
        </p>
	</div>
