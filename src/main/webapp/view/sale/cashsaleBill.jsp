...
<html>
  <head>
    <base href="<%=basePath%>">
	<script src='<%=basePath%>script/sale/cashsaleBill.js' 	type='text/javascript'></script>
    <title>出入库单</title>
	 ...
	 <div style="display:none">
	     ...
	     <!--startprint-->
	     	<table style="text-align:center;font-size:14px;width:120px;">
	     		...
	     		<tr>
	     			<td style="width:60px">业务日期：</td><td colspan="2"><label id="lbl_saleTime"></label></td> 
	     		</tr>
	     		<tr>
	     		...
	     		<tr>
	     			<td>商品</td><td style="width:30px">数量</td><td>金额(元)</td>
	     		</tr>
	     		<tr> 
	     			<td colspan="3">
