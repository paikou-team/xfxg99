...
//    	url: 'organization/getSortList.do',
        ...
        columns: [[
               ...
               { field: 'id', title: 'Id', width: 130, align: 'left', hidden: true },
               { title: '层级', field: 'level', align: 'left', hidden: false },
               { title: 'parentId', field: 'parentId', align: 'left', hidden: true },
               { title: 'parentName', field: 'parentName', align: 'left', hidden: true },
               { title: 'path', field: 'path', align: 'left', hidden: true },
               { title: 'OrderNo', field: 'OrderNo', align: 'left', hidden: true },
               { title: 'lng', field: 'lng', align: 'left', hidden: true },
               { title: 'lat', field: 'lat', align: 'left', hidden: true },
               { title: 'isStock', field: 'isStock', width: 50, align: 'left' ,hidden: true },
